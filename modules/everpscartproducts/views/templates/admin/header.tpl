...
<div class="panel everheader">
    <div class="panel-heading">
        <i class="icon icon-smile"></i> {l s='Ever Cart Products' mod='everpscartproducts'}
    </div>
    <div class="panel-body">
        <div class="col-xs-12 col-lg-6">
            ...
            <strong>{l s='Welcome to Ever Cart Products !' mod='everpscartproducts'}</strong><br />{l s='Please configure your this form to set associated products' mod='everpscartproducts'}<br />
            <p>
                <strong>
                    {l s='Click on our logo to go direct to bottom' mod='everpscartproducts'}
                </strong>
            </p>
        </div>
        <div class="col-xs-12 col-lg-6">
            <p class="alert alert-warning">
                {l s='This module is free and will always be ! You can support our free modules by making a donation by clicking the button below' mod='everpscartproducts'}
            </p>
