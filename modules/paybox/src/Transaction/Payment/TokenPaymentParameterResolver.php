...
/**
 * Class TokenPaymentParameterResolver
 * @package Up2pay\Transaction\Payment
 */
class TokenPaymentParameterResolver extends AbstractPaymentParameterResolver
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ...
            ->setNormalizer(
                'PBX_DATEVAL',
                function (Options $options, $value) {
                    return Tools::substr($value, 2, 2).Tools::substr($value, 0, 2);
                }
            )
            ->setNormalizer(
                'PBX_CMD',
