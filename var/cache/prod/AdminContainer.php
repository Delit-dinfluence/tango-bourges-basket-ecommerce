...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'zdrjisjtbb.mysql.db', 'port' => '', 'dbname' => 'zdrjisjtbb', 'user' => 'zdrjisjtbb', 'password' => 'duU29LpQ2', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home/zdrjisj/www/boutique/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/home/zdrjisj/www/boutique/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home/zdrjisj/www/boutique/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/home/zdrjisj/www/boutique/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/home/zdrjisj/www/boutique/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/home/zdrjisj/www/boutique/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6c6158e9f1db0464c7986c294a216659bd560fcb43f1637628fb58b153333558');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/zdrjisj/www/boutique/var/cache/prod//localization');
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.7.8', '/home/zdrjisj/www/boutique', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.8', '/home/zdrjisj/www/boutique');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/home/zdrjisj/www/boutique/app',
            'kernel.project_dir' => '/home/zdrjisj/www/boutique',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/home/zdrjisj/www/boutique/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                66 => 'contentbox',
                67 => 'everblock',
                68 => 'everpscartproducts',
                69 => 'baproductscarousel',
                70 => 'ybc_nivoslider',
                71 => 'paybox',
            ],
            'ps_cache_dir' => '/home/zdrjisj/www/boutique/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/zdrjisj/www/boutique/var/cache/prod//doctrine/orm/Proxies',
