...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61aa5a155fc436_97592811',
...
function content_61aa5a155fc436_97592811 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    <div class="col-md-6 wrapper">
      <!-- debug id -->
      <?php if ($_smarty_tpl->tpl_vars['linkBlock']->value['id'] == "1") {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php } else { ?>
      ...
      href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['url'], ENT_QUOTES, 'UTF-8');?>
"
              id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['id'], ENT_QUOTES, 'UTF-8');?>
"
              class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['class'], ENT_QUOTES, 'UTF-8');?>
"
              title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['description'], ENT_QUOTES, 'UTF-8');?>
"
              <?php if (!empty($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['target'])) {?> target="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['linkBlock']->value['links'][0]['target'], ENT_QUOTES, 'UTF-8');?>
" <?php }?>>
